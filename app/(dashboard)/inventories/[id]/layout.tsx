    ...
    <div className="space-y-6 animate-fade-in relative">
      ...
      <div>
        <div className="mb-2 flex items-center gap-2 text-xs font-semibold text-stone-400">
          <Link href="/" className="hover:text-[#1a7949] transition-colors flex items-center gap-1 font-medium">
            <span>← All Stores</span>
          </Link>
          <span>/</span>
          <span className="text-stone-700 font-bold">{inventory.name}</span>
        </div>
