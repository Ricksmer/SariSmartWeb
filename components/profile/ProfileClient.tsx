...
Powered by SariSmart OS 🌿`;
  ...
  return (
    <div className="space-y-8 animate-fade-in pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-emerald-900/10 pb-4">
        <div>
        ...
        <div className="flex items-center gap-2">
          <Link href="/" className="btn btn-secondary text-xs sm:text-sm py-2 px-3.5 border-emerald-300/80 hover:bg-emerald-50 hover:text-[#1a7949] font-bold inline-flex items-center gap-1.5">
